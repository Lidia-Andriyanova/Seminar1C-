...
double[,] GetDoubleMatrix(int m, int n, double min, double max)
{
...
Console.Write("Введите число колонок в двумерном массиве: ");
int col = Convert.ToInt32(Console.ReadLine());


double[,] matrix = GetDoubleMatrix(row, col, -10, 10);
PrintMatrix(matrix);
